...
public class ChatView extends JFrame implements ChatModel.ChatListener {
    ...
    private void createComponents() {
        ...
        userHeader.add(new JLabel("Users"), BorderLayout.WEST);
        ...
        userHeader.add(refreshUsersButton, BorderLayout.EAST);
        ...
        JButton refreshListButton = new JButton("Refresh");
        refreshListButton.addActionListener(e -> {
            if (controller != null) {
                controller.handleCommand("LIST");
            }
        });
        channelButtons.add(refreshListButton);
    }
    ...
    private void handleSendMessage() {
        ...
        if (!message.isEmpty()) {
            if (message.toUpperCase().startsWith("NICK ") ||
                    message.toUpperCase().startsWith("JOIN ") ||
                    message.toUpperCase().startsWith("PART ") ||
                    message.toUpperCase().startsWith("LIST") ||
                    message.toUpperCase().startsWith("QUIT")) {
